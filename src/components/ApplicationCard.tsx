...
const ApplicationCard = ({ application, children }: ApplicationCardProps) => {
  const [imgSrc, setImgSrc] = useState(
    application?.property?.imageUrls?.[0] || "/placeholder.jpg"
  );
  ...
  //   phoneNumber: application?.landlordContactNumber,
  // };
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="text-sm flex items-center text-primary-600">
                  ...
                  {user?.role === "landlord"
                    ...
                    : user?.role === "tenant" &&
                      application?.landlordContactNumber &&
                      application?.landlordContactNumber
                    ? application?.landlordContactNumber
